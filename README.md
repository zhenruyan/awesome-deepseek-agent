...
| **VibeCoding** | Terminal AI coding assistant in ~10K lines of Go with DeepSeek as default provider, three modes, sandbox, and rich TUI. | [Guide](./docs/vibecoding.md) |
